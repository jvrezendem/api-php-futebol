...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Adicionar e Modificar Clube</title>
    </head>
    <body>
        <h1 id="titulo">Adicionar e Modificar Clube</h1>

        <form action="addClube.php" method="POST">
            <?php
            ...
            ?>
            <center>
                <h3 id="tituloModificar">Modificar dados do clube</h3>
            </center>
            <?php 
                //Consulta SQL a ser realizada
                $sql = "SELECT * FROM clube WHERE idClube = ".$_GET["codigo"];
                $result = mysqli_query($con, $sql);
                $vetor = mysqli_fetch_array($result, MYSQLI_ASSOC);
                mysqli_close($con);
            ?>
            <input type="hidden" name="codigo" value="<?php echo $vetor["idClube"] ?>">
            <?php
                }else{
            ?>
            <center>
                <h3 id="tituloAdicionar">Adicionar clube</h3>
            </center>
            <?php
                }
            ?>
            ...
            <table border = "1" cellspace = "0" class="tabela">
                <tr>
                    <td>
                        <font size = "3"> Digite os dados do clube: </font>
                    </td>
                </tr>
                ...
                <tr> 
                    ...
                    <td colspan="2" width = 80%>
                        <input type = "text" name = "idClube" value = "<?php echo @$vetor["idClube"] ?>" maxlength="50" size="31"> 
                    </td>
                </tr>   

                <tr> 
                    <td width = 20%>
                        <font size = "3"> Nome do Clube: </font>
                    </td>
                    <td colspan="2" width = 80%>
                ...
                <tr> 
                    <td width = 20%>
                        <font size = "3"> Ano de Fundação: </font>
                    </td>
                    <td colspan="2" width = 80%>
                        <input type = "text" name = "anoFundacao" value = "<?php echo @$vetor["anoFundacao"] ?>" maxlength="50" size="31"> 
                    </td>
                </tr>
